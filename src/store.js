...
const cartItemsFromStorage = userLoginFromStorage && JSON.parse(localStorage.getItem(userLoginFromStorage.id)) ? JSON.parse(localStorage.getItem(userLoginFromStorage.id)) : []
...
const initialState = {
    auth: {
        ...
        userLogin: userLoginFromStorage ? userLoginFromStorage : null
    },
    cart: {
