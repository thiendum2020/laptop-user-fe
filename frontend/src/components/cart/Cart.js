                                                                            ...
                                                                            <tr key={item.product_id}>
                                                                                <td>
                                                                                    <div className="cart-info">
                                                                                        ...
                                                                                        <div style={{ maxWidth: "360px" }}>
                                                                                            ...
                                                                                            <span onClick={() => removeCartItemHandler(item.product_id)} >Remove</span>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                ...
                                                                                <td style={{ textAlign: "center" }}>
                                                                                    <div className="product-quantity-wrapper">
                                                                                        <span className="product-quantity-btn" onClick={() => decreaseQty(item.product_id, item.qty)}>
                                                                                            <i className="bx bx-minus"></i>
                                                                                        </span>
                                                                                        <input type="number" className="product-quantity" value={item.qty} readOnly />
                                                                                        <span className="product-quantity-btn" onClick={() => increaseQty(item.product_id, item.qty, item.quantity)}>
                                                                                ...
                                                                                <td style={{ textAlign: "right" }}>
                                                                                    <NumberFormat value={item.price * item.qty} displayType={'text'} thousandSeparator={true} prefix={'đ '} />
                                                                                </td>
                                                                            </tr>
                                                                        ))
                                                                    }
                                                                ...
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <b>
                                                                                    <NumberFormat value={cartItems.reduce((acc, item) => acc + item.qty * item.price, 0)} displayType={'text'} thousandSeparator={true} prefix={'đ '} />
                                                                                </b>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
