...
const Profile = ({ history }) => {
    ...
    const [avatarPreview, setAvatarPreview] = useState('https://media-cdn.laodong.vn/storage/newsportal/2021/9/2/949228/Ronaldo-Mu1-02.jpg')
                            ...
                            <div className="col-4">
                                <div className='form-group user-avatar'>
                                    ...
                                    <figure className='avatar-profile'>
                                        <img className="rounded-circle img-fluid" src={avatarPreview} alt={userLogin.username} />
                                    </figure>
                                    {/* <p>Max size: 5MB</p>
                                    <p>Type:.JPEG, .PNG</p>
